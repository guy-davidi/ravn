...
enum syscall_number {
	...
	SYS_MKDIRAT = 258,	     /* Create directory relative to directory file
					descriptor */
	...
	SYS_TIMERFD_CREATE = 283,    /* Create timer that delivers timer expiration
					notifications */
	...
	SYS_KCMP = 312,		     /* Compare two processes to determine if they share
					kernel resources */
